...
$config['ci_metronic'] = array(
	...
	'scripts' => array(
		...
		'foot'	=> array(
			...
			'assets/dist/metronic/js/widgets.bundle.js',
			'assets/dist/metronic/js/custom/widgets.js',
			'assets/dist/metronic/js/custom/apps/chat/chat.js',
			'assets/dist/metronic/js/custom/utilities/modals/upgrade-plan.js',
			'assets/dist/metronic/js/custom/utilities/modals/create-app.js',
			'assets/dist/metronic/js/custom/utilities/modals/users-search.js',
		),
	),
	...
	// Default CSS class for <body> tag
	'body_class' => '',
	'body_style' => '--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px',
